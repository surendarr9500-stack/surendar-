...
OUT = os.path.join(os.path.dirname(__file__),
                   "SIH2026_CAPACITY_CONNECT_26075_OFFICIAL_TEMPLATE.pptx")
...
def chrome(s, num, title=None):
    """Official SIH template chrome: team box (top-left), centred title,
    SIH badge (top-right), dark footer bar with page number."""
    rect(s, 0, 0, W, H, WHITE)

    # team-name box, top-left
    rect(s, Inches(0.16), Inches(0.10), Inches(0.78), Inches(0.66), WHITE, line=BORDER)
    tb = s.shapes.add_textbox(Inches(0.16), Inches(0.14), Inches(0.78), Inches(0.6))
    tf = tb.text_frame
    tf.word_wrap = True
    tf.margin_left = tf.margin_right = tf.margin_top = tf.margin_bottom = 0
    for i, word in enumerate(TEAM.split()[:3] or ["Your", "Team", "Name"]):
    ...
    # SIH badge, top-right
    rect(s, Inches(11.62), Inches(0.10), Inches(1.55), Inches(0.72), WHITE, line=BORDER,
         radius=True)
    rect(s, Inches(11.62), Inches(0.10), Inches(1.55), Pt(4), ORANGE, radius=False)
    text(s, Inches(11.66), Inches(0.24), Inches(1.47), Inches(0.5),
         [("SMART INDIA", 8, NAVY, True)], align=PP_ALIGN.CENTER)
    text(s, Inches(11.66), Inches(0.40), Inches(1.47), Inches(0.5),
         [("HACKATHON", 8, NAVY, True)], align=PP_ALIGN.CENTER)
    text(s, Inches(11.66), Inches(0.56), Inches(1.47), Inches(0.5),
         [("2026", 8, ORANGE, True)], align=PP_ALIGN.CENTER)

    if title:
        text(s, Inches(1.2), Inches(0.20), Inches(10.3), Inches(0.55),
             [(title, 27, INK, True)], align=PP_ALIGN.CENTER)
        rect(s, Inches(4.4), Inches(0.82), Inches(4.5), Pt(3), ORANGE)

    # footer bar
    rect(s, 0, H - Inches(0.34), W, Inches(0.34), FOOT)
    text(s, Inches(4.0), H - Inches(0.26), Inches(5.33), Inches(0.22),
         [("@SIH Idea submission- Template", 9, WHITE, False)], align=PP_ALIGN.CENTER)
    text(s, Inches(12.4), H - Inches(0.26), Inches(0.6), Inches(0.22),
...
text(s, Inches(1.2), Inches(0.95), Inches(10.3), Inches(0.5),
     [("TITLE PAGE", 17, ORANGE, True)], align=PP_ALIGN.CENTER)
text(s, Inches(1.2), Inches(1.32), Inches(10.3), Inches(0.7),
     [("SMART INDIA HACKATHON 2026", 34, INK, True)], align=PP_ALIGN.CENTER)
rect(s, Inches(5.4), Inches(2.02), Inches(2.5), Pt(4), ORANGE)
...
picture(s, "digital_twin_box.png", Inches(9.25), Inches(2.35), Inches(3.35), Inches(2.2),
        "Digital Twin concept (illustrative)")
rect(s, Inches(9.25), Inches(4.9), Inches(3.35), Inches(1.6), LTBLUE, line=BORDER)
text(s, Inches(9.5), Inches(5.04), Inches(2.9), Inches(0.28),
     [("ORGANISATION", 10, BLUE, True)])
text(s, Inches(9.5), Inches(5.28), Inches(2.95), Inches(0.5),
     [("Ministry of Earth Sciences (MoES)", 12, NAVY, True)], line_spacing=1.12)
text(s, Inches(9.5), Inches(5.84), Inches(2.9), Inches(0.28),
     [("DEPARTMENT", 10, BLUE, True)])
text(s, Inches(9.5), Inches(6.08), Inches(2.95), Inches(0.4),
     [("India Meteorological Department", 12, NAVY, True)], line_spacing=1.12)

rect(s, Inches(0.7), Inches(6.42), Inches(8.2), Inches(0.52), LTORANGE, radius=True)
text(s, Inches(0.9), Inches(6.55), Inches(7.9), Inches(0.32),
